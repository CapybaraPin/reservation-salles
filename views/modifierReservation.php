                    ...
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="typeActivite" name="typeActivite" class="form-select" required>
                                        <option value="0">Sélectionnez le type d'activité</option>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                ...
                                <div id="typeDescription" style="<?php if ($reservation["IDENTIFIANT_ACTIVITE"] != 1 AND $reservation["IDENTIFIANT_ACTIVITE"] != 3 AND $reservation["IDENTIFIANT_ACTIVITE"] != 6) { echo "display:none;"; } ?>">
                                    <div class="mb-3">
                                ...
                                <div id="typeLocation" style="<?php if ($reservation["IDENTIFIANT_ACTIVITE"] != 4 OR $reservation["IDENTIFIANT_ACTIVITE"] != 5) { echo "display:none;"; } ?>">
                                    <div class="mb-3">
                                        ...
                                        <select id="nomOrganisme" name="nomOrganisme" class="form-select" required>
